      ...
      start_supervised(
        {ApplicationRunner.Session.MetadataAgent,
         %ApplicationRunner.Session.Metadata{
           ...
           user_id: user.id,
           function_name: "",
           token: env_id |> ApplicationRunner.AppSocket.do_create_session_token(1, user.id) |> elem(1),
           context: %{}
         }}
      )
      ...
      start_supervised(
        {ApplicationRunner.Session.MetadataAgent,
         %ApplicationRunner.Session.Metadata{
           ...
           user_id: user.id,
           function_name: "",
           token: env_id2 |> ApplicationRunner.AppSocket.do_create_session_token(1, user.id) |> elem(1),
           context: %{}
         }}
      )
