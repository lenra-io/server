defmodule LenraWeb.ErrorHelpers do
  ...
  @errors [
    ...
    json_format_error: %{code: 15, message: "Json format are not valid"},
    json_ref_format_error: %{code: 16, message: "You specify Ref in your json but ref are nil"},
    data_not_found: %{code: 17, message: "Data id not found"},
    datastore_not_found: %{code: 18, message: "You attempt add data on unknow datastore"},
