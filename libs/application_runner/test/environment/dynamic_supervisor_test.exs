defmodule ApplicationRunner.Environment.DynamixSupervisorTest do
  ...
  test "should scale to one on environment start and to zero on environment exit" do
  ...
  test "should scale to 1 on environment start and stay at 1 on environment exit" do
    {:ok, %{id: env_id}} = Repo.insert(Contract.Environment.new())
  ...
  test "update env scale options while env open" do
    {:ok, %{id: env_id}} = Repo.insert(Contract.Environment.new())
