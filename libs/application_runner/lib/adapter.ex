defmodule ApplicationRunner.Adapter do
  ...
  @doc """
    Override this function to return the scale options from the env id to the server/devtools needs
  """
  @callback get_scale_options(integer()) :: %{min: number(), max: number()}
